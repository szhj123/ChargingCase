...
QT_MOC_LITERAL(1, 6, 14), // "checkedChanged"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 7), // "checked"
QT_MOC_LITERAL(4, 30, 10) // "Update_Val"

    },
    "MyBtn\0checkedChanged\0\0checked\0Update_Val"
};
...
void MyBtn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyBtn *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkedChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->Update_Val(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyBtn::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyBtn::checkedChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyBtn::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MyBtn.data,
    qt_meta_data_MyBtn,
    qt_static_metacall,
    nullptr,
    nullptr
...
// SIGNAL 0
void MyBtn::checkedChanged(bool _t1)
{
