...
#include <memory>
#include "../../ChargingCase/myserialport.h"
...
QT_MOC_LITERAL(1, 13, 21), // "Serial_Port_Recv_Data"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "MySerialPort\0Serial_Port_Recv_Data\0"
};
...
void MySerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Serial_Port_Recv_Data(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
